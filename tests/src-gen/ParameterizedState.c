...
// /lf-flexpret-scripts/tests/ParameterizedState.lf
#define NUMBER_OF_FEDERATES 1
#include "core/reactor.c"
// =============== START reactor class Foo
typedef struct {
    int bank_index;
    #line 3 "file:/lf-flexpret-scripts/tests/ParameterizedState.lf"
    int bar;
    #line 4 "file:/lf-flexpret-scripts/tests/ParameterizedState.lf"
    int baz;
    #line 6 "file:/lf-flexpret-scripts/tests/ParameterizedState.lf"
...
void fooreaction_function_0(void* instance_args) {
    ...
    #line 7 "file:/lf-flexpret-scripts/tests/ParameterizedState.lf"
    printf("Baz: %d\n", self->baz);
