...
// /lf-flexpret-scripts/tests/HelloWorld.lf
#define NUMBER_OF_FEDERATES 1
#include "core/reactor.c"
// =============== START reactor class HelloWorld
typedef struct {
    int bank_index;
    #line 3 "file:/lf-flexpret-scripts/tests/HelloWorld.lf"
    bool success;
    #line 4 "file:/lf-flexpret-scripts/tests/HelloWorld.lf"
    reaction_t ___reaction_0;
    #line 8 "file:/lf-flexpret-scripts/tests/HelloWorld.lf"
...
void helloworldreaction_function_0(void* instance_args) {
    ...
    #line 5 "file:/lf-flexpret-scripts/tests/HelloWorld.lf"
    printf("Hello World.\n");
    self->success = true;
...
void helloworldreaction_function_1(void* instance_args) {
    helloworld_self_t* self = (helloworld_self_t*)instance_args;
    #line 9 "file:/lf-flexpret-scripts/tests/HelloWorld.lf"
...
typedef struct {
    int bank_index;
} helloworldtest_self_t;
helloworldtest_self_t* new_HelloWorldTest() {
    helloworldtest_self_t* self = (helloworldtest_self_t*)calloc(1, sizeof(helloworldtest_self_t));
    return self;
}
void delete_HelloWorldTest(helloworldtest_self_t* self) {
    free(self);
}
...
void __initialize_trigger_objects() {
    ...
    helloworldtest_self_t* helloworldtest_self = new_HelloWorldTest();
    //***** Start initializing HelloWorldTest
    // ************* Instance HelloWorldTest.a of class HelloWorld
    helloworld_self_t* helloworldtest_a_self = new_HelloWorld();
    //***** Start initializing HelloWorldTest.a
    __startup_reactions[0] = &helloworldtest_a_self->___reaction_0;
    __shutdown_reactions[0] = &helloworldtest_a_self->___reaction_1;
    static bool helloworldtest_a_initial_success = false;
    helloworldtest_a_self->success = helloworldtest_a_initial_success;
    //***** End initializing HelloWorldTest.a
    //***** End initializing HelloWorldTest
    // Populate arrays of trigger pointers.
    helloworldtest_self->bank_index = 0;
    helloworldtest_a_self->bank_index = 0;
    // Total number of outputs produced by the reaction.
    helloworldtest_a_self->___reaction_0.num_outputs = 0;
    // Allocate arrays for triggering downstream reactions.
    if (helloworldtest_a_self->___reaction_0.num_outputs > 0) {
        helloworldtest_a_self->___reaction_0.output_produced = (bool**)malloc(sizeof(bool*) * helloworldtest_a_self->___reaction_0.num_outputs);
        helloworldtest_a_self->___reaction_0.triggers = (trigger_t***)malloc(sizeof(trigger_t**) * helloworldtest_a_self->___reaction_0.num_outputs);
        helloworldtest_a_self->___reaction_0.triggered_sizes = (int*)malloc(sizeof(int) * helloworldtest_a_self->___reaction_0.num_outputs);
    }
    // Initialize the output_produced array.
    // Total number of outputs produced by the reaction.
    helloworldtest_a_self->___reaction_1.num_outputs = 0;
    // Allocate arrays for triggering downstream reactions.
    if (helloworldtest_a_self->___reaction_1.num_outputs > 0) {
        helloworldtest_a_self->___reaction_1.output_produced = (bool**)malloc(sizeof(bool*) * helloworldtest_a_self->___reaction_1.num_outputs);
        helloworldtest_a_self->___reaction_1.triggers = (trigger_t***)malloc(sizeof(trigger_t**) * helloworldtest_a_self->___reaction_1.num_outputs);
        helloworldtest_a_self->___reaction_1.triggered_sizes = (int*)malloc(sizeof(int) * helloworldtest_a_self->___reaction_1.num_outputs);
    }
    // Initialize the output_produced array.
    // Reaction 0 of HelloWorldTest.a does not depend on one maximal upstream reaction.
    helloworldtest_a_self->___reaction_0.last_enabling_reaction = NULL;
    // Reaction 1 of HelloWorldTest.a depends on one maximal upstream reaction.
    helloworldtest_a_self->___reaction_1.last_enabling_reaction = &(helloworldtest_a_self->___reaction_0);
    // doDeferredInitialize
    // Connect inputs and outputs for reactor HelloWorldTest.
    // Connect inputs and outputs for reactor HelloWorldTest.a.
    // END Connect inputs and outputs for reactor HelloWorldTest.a.
    // END Connect inputs and outputs for reactor HelloWorldTest.
    
    helloworldtest_a_self->___reaction_0.chain_id = 1;
    // index is the OR of level 0 and 
    // deadline 140737488355327 shifted left 16 bits.
    helloworldtest_a_self->___reaction_0.index = 0x7fffffffffff0000LL;
    helloworldtest_a_self->___reaction_1.chain_id = 1;
    // index is the OR of level 1 and 
    // deadline 140737488355327 shifted left 16 bits.
    helloworldtest_a_self->___reaction_1.index = 0x7fffffffffff0001LL;
}
